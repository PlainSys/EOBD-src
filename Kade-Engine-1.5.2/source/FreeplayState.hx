...
class FreeplayState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (accepted)
		{
			...
			switch (songLowercase) {
				...
				//case 'flans-frightful-song': songLowercase = 'flans-frightful-song';
			}
	...
	function changeDiff(change:Int = 0)
	{
		...
		switch (curDifficulty)
		{
			...
			case 2:
				diffText.text = "HARD";
			case 3:
				diffText.text = "LUNATIC";
			case 4:
				diffText.text = "EXTRA"; //only for some songs
		}
	}
	...
	function changeSelection(change:Int = 0)
	{
		...
		//switch (curDifficulty) {
			//case 'Flans-Frightful-song': curDifficulty = 'EXTRA';
		//}
