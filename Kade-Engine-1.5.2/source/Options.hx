...
class FullscreenOption extends Option
{
	...
	public override function press():Bool
	{
		FlxG.save.data.full = !FlxG.save.data.full;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.full ? "Fullscreen On" : "Fullscreen Off";
	}
}
...
class HealthOption extends Option
{
	...
	public override function press():Bool
	{
		FlxG.save.data.heal = !FlxG.save.data.heal;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.heal ? "one HP" : "Normal";
	}
}
...
class HideDeathOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.hide = !FlxG.save.data.hide;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.hide ? "Hide Bullet Notes: on" : "Hide Bullet Notes: off";
	}
...
class NoteSkinsOption extends Option
{
	...
	public override function press():Bool
	{
		FlxG.save.data.notesk = !FlxG.save.data.notesk;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.notesk ? "Note Skin: Touhou Item" : "Note Skin: Standard";
	}
}

class MorTapOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.mor = !FlxG.save.data.mor;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.mor ? "Play Touhou" : "Play Touhou";
	}
...
class InvinceOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.invinc = !FlxG.save.data.invinc;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.invinc ? "Disabled" : "Enter Codes";
	}
}
